...
const [statusOpen, setStatusOpen] = useState(false); // desktop starts open, mobile starts collapsed
...
useEffect(() => {
  ...
  const shellCss = `
    ...
    @media (max-width: ${MOBILE_MAX_W}px){
           .mapControlDock{
        left: 8px;
        right: 64px;
        top: 8px;
      ...
      .mapControlDockInner::-webkit-scrollbar{
        display: none;
      }
    }
  `;
    ...
    <div className="mapAppShell">
      ...
      <main className="content">
        <div className="mapStage">
          ...
          <div className="mapControlDock">
            <div className="mapControlDockInner">
              <button
                style={ui.iconBtn}
                onClick={() => {
                  setMenuOpen((v) => !v);
              ...
              <label
                style={ui.iconBtn}
                title="Quick tag from photo"
                aria-label="Quick tag from photo"
              >
          ...
          >
            <div className="statusChipTop">
              ...
              <span className="statusChipChevron" aria-hidden="true">
                {statusOpen ? "▾" : "▸"}
              </span>
            </div>
                ...
                <div style={{ display: "grid", gap: 10 }}>
                  {specimenList.map((r) => (
                    ...
                    >
                      ...
                      <div style={ui.small}>
                        {r.observed_date ? `Observed: ${r.observed_date}` : "Observed: —"}
                      </div>
                    </div>
                  ))}
                </div>
